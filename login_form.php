            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group <?php echo $csshaserror; ?>">
                        <label for="inputUsername <?php echo $csser; ?>" class="col-sm-3 control-label">Username</label>
                        <div class="col-sm-9">
                            <input type="text" name="Username" class="form-control" id="inputUsername <?php echo $csser; ?>" placeholder="Username" required>
                        </div>
                    </div>
                    <div class="form-group <?php echo $csshaserror; ?>">
                        <label for="inputPassword <?php echo $csser; ?>" class="col-sm-3 control-label">
                            Password</label>
                        <div class="col-sm-9">
                            <input type="password" name="password" class="form-control" id="inputPassword <?php echo $csser; ?>" placeholder="Password" maxlength="<?php echo $zw->config['max_password']; ?>" required>
                        </div>
                    </div>
                ...
                <div class="panel-footer">
                    <a href="<?php echo $site_address; ?>/register.php">Register here</a><br>
                    <a href="<?php echo $site_address; ?>/resetpassword.php">Reset Password here</a>
                </div>
            </div>
<small>
...
Don't worry it doesn't store your password. Just your id, session id and the time in unix format.<br>
</small>
</form>