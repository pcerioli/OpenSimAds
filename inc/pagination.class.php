...
function paging($tbl_name, $targetpage, $limit) {
	...
	*/
	$query = $this->zw->SQL->query("SELECT COUNT(*) AS num FROM $tbl_name");
	$total_pages = $this->zw->SQL->fetch_assoc($query);
	$total_pages = $total_pages[num];
	
	/* Setup vars for query. */

	$page = $this->zw->Security->make_safe($_GET['page']);
	if($page) {
